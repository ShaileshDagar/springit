...
//    private final String BASE_URL = "http://localhost:8080";
    ...
    @Async
    public void sendEmailFromTemplate(User user, String templateName, String subject, String baseURL) {
    ...
    public void sendActivationEmail(User user, String baseURL) {
        ...
        sendEmailFromTemplate(user, "email/activation", "Springit User Activation", baseURL);
    }

    @Async
    public void sendWelcomeEmail(User user, String baseURL) {
        log.debug("Sending activation email to '{}'", user.getEmail());
        sendEmailFromTemplate(user, "email/welcome", "Welcome new Springit User", baseURL);
    }
